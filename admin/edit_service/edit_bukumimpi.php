...
<div class="container">
    ...
    <form action="" method="post">
        ...
        <div class="form-group">
            <label>Nomor</label>
            <input type="text" class="form-control" name="nomor_game" value="444">
            <span class="form_error"></span>
        </div>

        <div class="form-group">
            <label>Keterangan</label>
            <input type="text" class="form-control" name="keterangan" value="Kepala Rampok - Singa - Loncat Indah,Lompat - Kayu Manis - Kereta Api - Garu Langit">
            <span class="form_error"></span>
        </div>
