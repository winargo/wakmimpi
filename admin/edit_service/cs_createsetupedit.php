...
<?php
    ...
    include("blockadmin.php");
        ...
        if (!$result) {
            ...
            //}
                $sql="update `customerservice` set type='".$_POST['sosmedbrand']."',contact='".$_POST['sosmed']."',username='".$_SESSION['adminname']."' where type='".$_POST['oldtype']."' and contact='".$_POST['oldcontact']."'";
            //else{
